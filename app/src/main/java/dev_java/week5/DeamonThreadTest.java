...
public class DeamonThreadTest implements ActionListener {
  ...
  public static void main(String[] args) {
    Thread th = new Thread() {
      public void run() {// Override
        try {
          Thread.sleep(5000);// 5초동안 정지상태-죽지는 않고 멈춤
    ...
    // setDaemon을 사용하여 옵션을 true로 주면 thread와 상관없이 앱 종료시킴
    // 프로그램에서 처리하는 것와 상관없이 별개로 동작해야하는것이 있으면
    // 이 메소드를 호출하지 말거나 추가했다면 false로 설정하면 된다.
